    ...
    <div class="app-wrapper">
        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="#" class="nav-link">Contact</i></a></li>
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('template/dist/assets/img/user1-128x128.jpg') }}"
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('template/dist/assets/img/user8-128x128.jpg') }}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('template/dist/assets/img/user3-128x128.jpg') }}"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            @if (Auth::user()->role == 'admin')
                                <x-icon-role name="Owner" icon="{{ Auth::user()->icon_role }}" />
                            @else
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-body">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <x-button-logout :href="route('logout')"
        ...
        <aside class="app-sidebar shadow" data-bs-theme="dark" style="background: #111827">
            ...
            <div class="sidebar-brand">
                <!--begin::Brand Link-->
                <a href="{{ url('/info') }}" class="brand-link">
                    <!--begin::Brand Image-->
                    <img src="{{ asset('img/AJ.png') }}" alt="Aj Fotokopi"
                        class="brand-image rounded-circle opacity-75 shadow" />
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">AJ FOTOKOPI</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    @if (!empty($page) && view()->exists($page))
                        @include($page)
                    @endif
        ...
        <footer class="app-footer">
            ...
            <strong>
                ...
                <a href="{{ asset('img/AJ.png') }}" class="text-decoration-none">AjFotokopi.io</a>
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer>
